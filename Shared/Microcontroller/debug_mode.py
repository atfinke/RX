...
class DebugMode:
    ...
    def _tlc_debug_mode(self, buttons):
        ...
        while True:
            ...
            leds[led_order[white_button_index]] = (HardwareConfig.MAX_LED_VALUE, HardwareConfig.MAX_LED_VALUE, HardwareConfig.MAX_LED_VALUE)
            ...
            while color_index < 3:
                for button in range(button_count):
                    if color_index == 0:
                        leds[led_order[button]] = (HardwareConfig.MAX_LED_VALUE, 0, 0)
                    elif color_index == 1:
                        leds[led_order[button]] = (0, HardwareConfig.MAX_LED_VALUE, 0)
                    else:
                        leds[led_order[button]] = (0, 0, HardwareConfig.MAX_LED_VALUE)
